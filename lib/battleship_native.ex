defmodule BattleshipNative do
  ...
  import BattleshipWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {BattleshipWeb.Layouts.SwiftUI, :app}
        ],
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([BattleshipWeb, CoreComponents, plugin.module_suffix])
